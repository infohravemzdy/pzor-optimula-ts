...
var ServiceOptimula = /** @class */ (function (_super) {
    ...
    ServiceOptimula.TEST_CALCS_ARTICLE = [
        ArticleCode.get(ArticlesConst_1.OptimulaArticleConst.ARTICLE_SETTLEM_TARGETS),
        ArticleCode.get(ArticlesConst_1.OptimulaArticleConst.ARTICLE_SETTLEM_RESULTS),
        ArticleCode.get(ArticlesConst_1.OptimulaArticleConst.ARTICLE_SETTLEM_ALLOWCE),
        ArticleCode.get(ArticlesConst_1.OptimulaArticleConst.ARTICLE_SETTLEM_AGRWORK),
        ArticleCode.get(ArticlesConst_1.OptimulaArticleConst.ARTICLE_INCOMES_TAXFREE),
        ArticleCode.get(ArticlesConst_1.OptimulaArticleConst.ARTICLE_INCOMES_TAXBASE),
        ArticleCode.get(ArticlesConst_1.OptimulaArticleConst.ARTICLE_INCOMES_TAXWINS),
        ArticleCode.get(ArticlesConst_1.OptimulaArticleConst.ARTICLE_INCOMES_SUMMARY),
    ];
